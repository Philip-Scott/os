...
rpm-ostree install screen conky pass htop code azure-cli obs-studio autofs okteta mkvtoolnix rocm-smi rocm-hip rocm-opencl rocminfo docker docker-compose nethogs 
